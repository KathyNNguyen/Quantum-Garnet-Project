...
const machines = [
    { id: 1, top: 17.97, left: 11.66, name: "Pirate Plunder", type: "Pirate Plunder", minBet: "$2.70" },
    { id: 2, top: 28.05, left: 8.26, name: "Fantasy Fortune", type: "Video Slots", minBet: "$3.75" },
    { id: 3, top: 28.05, left: 15.69, name: 'Wild West Whirl', type: 'Megaways', minBet: '$2.21' }
...
function addInteractiveStars() {
    machines.forEach(machine => {
        ...
        star.addEventListener('mouseenter', () => {
            ...
            `;
            tooltip.style.left = `${parseFloat(machine.left)}px`;
            tooltip.style.top = `${parseFloat(machine.top) - 30}px`;
        });
